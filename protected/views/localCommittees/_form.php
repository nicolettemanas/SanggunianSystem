...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save', array('id'=>'action')); ?>
	</div>
...
<script>
	(function(root){
		...
		document.getElementById('action').onclick = function(){
			return confirm("Overlapped positions will be replaced by new ones assigned. Do you want to proceed with the operation?");
		}
